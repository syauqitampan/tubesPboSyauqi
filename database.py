...
def execute_query(query: str, params: tuple = None):
    """Menjalankan query non-SELECT (misalnya INSERT, UPDATE, DELETE)."""
...
def get_dataframe(query: str, params: tuple = None) -> pd.DataFrame:
    """Menjalankan query SELECT dan mengembalikan hasilnya dalam bentuk DataFrame Pandas."""
    conn = get_db_connection()
    if not conn:
        return pd.DataFrame()
...
def setup_database_initial():
    """Memastikan tabel 'laporan' ada di database."""
